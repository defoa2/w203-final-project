...
Ultimately, our Control model works best as it explains the same degree of variability as our Complex model (Adj. R-squared = 52%), but with 10 less features. Because the Complex model could be reducing the effect size of important predictors, like $Student.Attendance$, we favor Occam's razor in this situation, and therefore conclude that our Control model performs the best.
