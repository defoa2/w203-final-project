...
stargazer(model_naive, learning_environment, controls, model_complex,
          ...
          omit = c("Effective.Leaders", "Ambitious.Instruction", "Collaborative.Teachers", "Suspension.Days", "Suspensions.Percent", "Latitude", "Longitude", "Involved.Families", "Supportive.Environment", "Safety"),
          add.lines = list(
