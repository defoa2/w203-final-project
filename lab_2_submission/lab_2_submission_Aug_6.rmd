...
controls <- lm(Student.Success ~ Suspensions.Percent +
                            Suspension.Days + 
                            Years.on.Probation +
                            Longitude +
                            Latitude +
                            School.Track, data = my_data)
```
...
stargazer(model_naive, learning_environment, controls, model_complex,
          ...
          omit = c("Effective.Leaders", "Ambitious.Instruction", "Collaborative.Teachers", "Suspension.Days", "Suspensions.Percent", "Latitude", "Longitude"),
          add.lines = list(
