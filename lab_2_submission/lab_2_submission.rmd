...
# location
# latitude
mod11 <- lm(Student.Performance.Reading.and.Math~Student.Attendance + Involved.Families + Safety + Years.on.Probation + Latitude, data=my_data)

waldtest(mod10, mod11,  vcov=vcovHC(mod11, type="HC0")) # not significant

# longitude
mod12 <- lm(Student.Performance.Reading.and.Math~Student.Attendance + Involved.Families + Safety + Years.on.Probation + Longitude, data=my_data)
